...
<body>
    <div id="food-items">
        <div class="food-item steak" draggable="true" data-price="10.0" style="top: -50px; left: -350px; color: black;">
    Steak - $10.00
</div>
        <div class="food-item bread" draggable="true" data-price="4.0" style="top: 0px; left: 0px; color: black;"> 
    Bread - $4.00
</div>
        <div class="food-item chips" draggable="true" data-price="3.0" style="top: 0px; left: 450px; color: black;"> 
    Chips - $3.00
</div>
        <div class="food-item watermelon" draggable="true" data-price="4.5" style="top: 50px; left: 250px; color: black;"> 
    Watermelon - $4.50
</div>
    </div>
